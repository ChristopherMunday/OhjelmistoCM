...
print(f"Auton huippunopeus on: {auto1.huippunopeus}. "
      f"Tämän hetkinen nopeus on: {auto1.nopeus_th}. "
      f"Kuljettu matka on: {auto1.kuljettu_matka}. "
      f"Rekisteritunnus on: {auto1.rekisteritunnus}. ")
